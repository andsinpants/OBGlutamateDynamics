...
for i = 1:size(sort_tbt51_fov1_sig,1)
    ...
    tbt51_fov1mat(roi,odor)=sort_tbt51_fov1_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 107 110 2 3 5 10 11 20 25 27 43 56 102 136];
tbt51_fov1_real=tbt51_fov1mat(:, rep_odor)'; %%transpose back for calculation of population sparseness;
...
for i = 1:size(sort_tbt51_fov2_sig,1)
    ...
    tbt51_fov2mat(roi,odor)=sort_tbt51_fov2_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 107 110 2 3 5 10 11 20 25 27 43 56 102 136];
tbt51_fov2_real=tbt51_fov2mat(:, rep_odor)'; %%transpose back for calculation of population sparseness;
...
for i = 1:size(sort_tbt57_fov1_sig,1)
    ...
    tbt57_fov1mat(roi,odor)=sort_tbt57_fov1_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 107 110 2 3 5 10 11 20 25 27 43 56 102 136];
tbt57_fov1_real=tbt57_fov1mat(:, rep_odor)'; %%transpose back for calculation of population sparseness;
...
for i = 1:size(sort_tbt57_fov2_sig,1)
    ...
    tbt57_fov2mat(roi,odor)=sort_tbt57_fov2_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 107 110 2 3 5 10 11 20 25 27 43 56 102 136];
tbt57_fov2_real=tbt57_fov2mat(:, rep_odor)'; %%transpose back for calculation of population sparseness;
...
for i = 1:size(sort_tbt61_lobfov1_sig,1)
    ...
    tbt61_lobfov1mat(roi,odor)=sort_tbt61_lobfov1_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 107 110 2 3 5 10 11 20 25 27 43 56 102 136];
tbt61_lobfov1_real=tbt61_lobfov1mat(:, rep_odor)'; %%transpose back for calculation of population sparseness;
...
for i = 1:size(sort_tbt61_lobfov2_sig,1)
    ...
    tbt61_lobfov2mat(roi,odor)=sort_tbt61_lobfov2_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 107 110 2 3 5 10 11 20 25 27 43 56 102 136];
tbt61_lobfov2_real=tbt61_lobfov2mat(:, rep_odor)'; %%transpose back for calculation of population sparseness;
...
for i = 1:size(sort_tbt61_rob_sig,1)
    ...
    tbt61_robmat(roi,odor)=sort_tbt61_rob_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 107 110 2 3 5 10 11 20 25 27 43 56 102 136];
tbt61_rob_real=tbt61_robmat(:, rep_odor)'; %%transpose back for calculation of population sparseness;
