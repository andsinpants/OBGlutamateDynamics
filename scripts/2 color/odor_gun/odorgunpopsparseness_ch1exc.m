...
for i = 1:size(sort_tbt68_sig,1)
    ...
    tbt68_mat(roi,odor)=sort_tbt68_sig(i,3);
end
...
for i = 1:size(sort_tbt78_robfov1_sig,1)
    ...
    tbt78_robfov1mat(roi,odor)=sort_tbt78_robfov1_sig(i,3);
end
...
for i = 1:size(sort_tbt78_robfov2_sig,1)
    ...
    tbt78_robfov2mat(roi,odor)=sort_tbt78_robfov2_sig(i,3);
end
...
for i = 1:size(sort_tbt78_lobfov1_sig,1)
    ...
    tbt78_lobfov1mat(roi,odor)=sort_tbt78_lobfov1_sig(i,3);
end
...
for i = 1:size(sort_tbt82_sig,1)
    ...
    tbt82_mat(roi,odor)=sort_tbt82_sig(i,3);
end
