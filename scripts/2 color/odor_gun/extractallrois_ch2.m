clc
clearvars -except totplot_odorch1uf

%% load odor file
% disp('Select Avg Ch2 Odor Gun File (1Hz filtered)')
% uiopen('load')
% 
...
% totplot_odorch21hz = horzcat(OdorNumID,allplot_odor1hz);
% 
...
disp('Select Avg Ch2 Odor Gun File (uniltered)')
uiopen('load')
...
totplot_odorch2uf = horzcat(OdorNumID,allplot_odoruf);
