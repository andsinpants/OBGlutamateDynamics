...
sort_tbt68_sig = sortrows(results_sig_tbt68,2);
sort_tbt78_robfov1_sig = sortrows(results_sig_tbt78_robfov1,2);
sort_tbt78_robfov2_sig = sortrows(results_sig_tbt78_robfov2,2);
sort_tbt78_lobfov1_sig = sortrows(results_sig_tbt78_lobfov1,2);
sort_tbt82_sig = sortrows(results_sig_tbt82,2);


%% tbt68_fov
tbt68_roinum = max(sort_tbt68_sig(:,1));

tbt68_mat = zeros(tbt68_roinum,136);

for i = 1:size(sort_tbt68_sig,1)
    roi=sort_tbt68_sig(i,1);
    odor=sort_tbt68_sig(i,2);
    tbt68_mat(roi,odor)=sort_tbt68_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 51 81 2 3 5 10 11 20 25 27 43 56 102 136];
tbt68_real=tbt68_mat(:, rep_odor);
tmpdata=tbt68_real;
...
%% tbt78_robfov1
tbt78_robfov1roinum = max(sort_tbt78_robfov1_sig(:,1));

tbt78_robfov1mat = zeros(tbt78_robfov1roinum,136);

for i = 1:size(sort_tbt78_robfov1_sig,1)
    roi=sort_tbt78_robfov1_sig(i,1);
    odor=sort_tbt78_robfov1_sig(i,2);
    tbt78_robfov1mat(roi,odor)=sort_tbt78_robfov1_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 51 81 2 3 5 10 11 20 25 27 43 56 102 136];
tbt78_robfov1_real=tbt78_robfov1mat(:, rep_odor);
...
%% tbt78_robfov2
tbt78_robfov2roinum = max(sort_tbt78_robfov2_sig(:,1));

tbt78_robfov2mat = zeros(tbt78_robfov2roinum,136);

for i = 1:size(sort_tbt78_robfov2_sig,1)
    roi=sort_tbt78_robfov2_sig(i,1);
    odor=sort_tbt78_robfov2_sig(i,2);
    tbt78_robfov2mat(roi,odor)=sort_tbt78_robfov2_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 51 81 2 3 5 10 11 20 25 27 43 56 102 136];
tbt78_robfov2_real=tbt78_robfov2mat(:, rep_odor);
...
%% tbt78_lobfov1
tbt78_lobfov1roinum = max(sort_tbt78_lobfov1_sig(:,1));

tbt78_lobfov1mat = zeros(tbt78_lobfov1roinum,136);

for i = 1:size(sort_tbt78_lobfov1_sig,1)
    roi=sort_tbt78_lobfov1_sig(i,1);
    odor=sort_tbt78_lobfov1_sig(i,2);
    tbt78_lobfov1mat(roi,odor)=sort_tbt78_lobfov1_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 51 81 2 3 5 10 11 20 25 27 43 56 102 136];
tbt78_lobfov1_real=tbt78_lobfov1mat(:, rep_odor);
...
%% tbt82_robfov1
tbt82_roinum = max(sort_tbt82_sig(:,1));

tbt82_mat = zeros(tbt82_roinum,136);

for i = 1:size(sort_tbt82_sig,1)
    roi=sort_tbt82_sig(i,1);
    odor=sort_tbt82_sig(i,2);
    tbt82_mat(roi,odor)=sort_tbt82_sig(i,4);
end

rep_odor = [1 6 9 13 23 24 28 33 40 45 51 81 2 3 5 10 11 20 25 27 43 56 102 136];
tbt82_real=tbt82_mat(:, rep_odor);
tmpdata=tbt82_real;
