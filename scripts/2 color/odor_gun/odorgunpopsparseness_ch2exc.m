...
for i = 1:size(sort_tbt68_sig2,1)
    ...
    tbt68_mat(roi,odor)=sort_tbt68_sig2(i,3);
end
...
for i = 1:size(sort_tbt78_robfov1_sig2,1)
    ...
    tbt78_robfov1mat(roi,odor)=sort_tbt78_robfov1_sig2(i,3);
end
...
for i = 1:size(sort_tbt78_robfov2_sig2,1)
    ...
    tbt78_robfov2mat(roi,odor)=sort_tbt78_robfov2_sig2(i,3);
end
...
for i = 1:size(sort_tbt78_lobfov1_sig2,1)
    ...
    tbt78_lobfov1mat(roi,odor)=sort_tbt78_lobfov1_sig2(i,3);
end
...
for i = 1:size(sort_tbt82_sig2,1)
    ...
    tbt82_mat(roi,odor)=sort_tbt82_sig2(i,3);
end
